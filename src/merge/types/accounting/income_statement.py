...
__all__ = ["IncomeStatement", "Income", "CostOfSale", "OperatingExpense", "NonOperatingExpense"]
...
class IncomeStatement(BaseModel):
    ...
    cost_of_sales: Optional[List[CostOfSale]]
    ...
    non_operating_expenses: Optional[List[NonOperatingExpense]]

    operating_expenses: Optional[List[OperatingExpense]]
