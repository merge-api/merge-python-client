...
__all__ = ["PurchaseOrderCreateParams", "Model", "ModelLineItem"]


class ModelLineItem(TypedDict, total=False):
    tracking_categories: Required[List[str]]
...
class Model(TypedDict, total=False):
    ...
    delivery_date: Annotated[Optional[Union[str, datetime]], PropertyInfo(format="iso8601")]
    ...
    issue_date: Annotated[Optional[Union[str, datetime]], PropertyInfo(format="iso8601")]
    ...
    status: Literal["DRAFT", "SUBMITTED", "AUTHORIZED", "BILLED", "DELETED"]
    """
    - `DRAFT` - DRAFT
    - `SUBMITTED` - SUBMITTED
