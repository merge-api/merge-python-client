...
__all__ = ["InvoiceCreateParams", "Model", "ModelLineItem"]
...
class Model(TypedDict, total=False):
    ...
    paid_on_date: Annotated[Optional[Union[str, datetime]], PropertyInfo(format="iso8601")]
    ...
    type: Literal["ACCOUNTS_RECEIVABLE", "ACCOUNTS_PAYABLE"]
    """
