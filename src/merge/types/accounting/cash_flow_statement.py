...
__all__ = ["CashFlowStatement", "OperatingActivity", "InvestingActivity", "FinancingActivity"]


class OperatingActivity(BaseModel):
    ...
    sub_items: Optional[List[Dict[str, object]]]
...
class CashFlowStatement(BaseModel):
    ...
    financing_activities: Optional[List[FinancingActivity]]
    ...
    operating_activities: Optional[List[OperatingActivity]]

    remote_data: Optional[List[shared.RemoteData]]

    remote_generated_at: Optional[datetime]
