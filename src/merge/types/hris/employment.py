...
class Employment(BaseModel):
    ...
    employment_type: Optional[Literal["FULL_TIME", "PART_TIME", "INTERN", "CONTRACTOR", "FREELANCE"]]
    """
    - `FULL_TIME` - FULL_TIME
    - `PART_TIME` - PART_TIME
    - `INTERN` - INTERN
    ...
    flsa_status: Optional[Literal["EXEMPT", "SALARIED_NONEXEMPT", "NONEXEMPT", "OWNER"]]
    """
    - `EXEMPT` - EXEMPT
    ...
    pay_period: Optional[
        Literal["HOUR", "DAY", "WEEK", "EVERY_TWO_WEEKS", "SEMIMONTHLY", "MONTH", "QUARTER", "EVERY_SIX_MONTHS", "YEAR"]
    ]
    """
    - `HOUR` - HOUR
    - `DAY` - DAY
