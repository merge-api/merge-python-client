...
from ....types.accounting import (
    ...
    ExpenseResponse,
    expense_list_params,
    expense_create_params,
    expense_retrieve_params,
)

if TYPE_CHECKING:
    from ...._client import Merge, AsyncMerge

__all__ = ["Expenses", "AsyncExpenses"]


class Expenses(SyncAPIResource):
    meta: Meta
    ...
    def create(
        self,
        *,
        model: expense_create_params.Model,
        ...
        return self._post(
            ...
            body=maybe_transform({"model": model}, expense_create_params.ExpenseCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ExpenseResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    expense_retrieve_params.ExpenseRetrieveParams,
                ),
            ),
            cast_to=Expense,
        )
    ...
    def list(
        ...
        *,
        ...
        Args:
          company_id: If provided, will only return expenses for this company.
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    expense_list_params.ExpenseListParams,
                ),
            ),
            model=Expense,
        )
...
class AsyncExpenses(AsyncAPIResource):
    meta: AsyncMeta
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Expense, AsyncPage[Expense]]:
        """
        Returns a list of `Expense` objects.
