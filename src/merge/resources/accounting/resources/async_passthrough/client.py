...
class AsyncPassthroughClient:
    ...
    def create(self, *, request: DataPassthroughRequest) -> AsyncPassthroughReciept:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment.value}/", "api/accounting/v1/async-passthrough"),
    ...
    def retrieve(self, async_passthrough_receipt_id: str) -> RemoteResponse:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            urllib.parse.urljoin(
                f"{self._environment.value}/", f"api/accounting/v1/async-passthrough/{async_passthrough_receipt_id}"
            ),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
