...
from .types.tax_rates_list_request_expand_item import TaxRatesListRequestExpandItem
...
class TaxRatesClient:
    ...
    def list(
        ...
        *,
        ...
        expand: typing.Optional[
            typing.Union[TaxRatesListRequestExpandItem, typing.Sequence[TaxRatesListRequestExpandItem]]
        ] = None,
    ...
    ) -> SyncPager[TaxRate, PaginatedTaxRateList]:
        """
        ...
        expand : typing.Optional[typing.Union[TaxRatesListRequestExpandItem, typing.Sequence[TaxRatesListRequestExpandItem]]]
    ...
    def retrieve(
        ...
        *,
        expand: typing.Optional[
            typing.Union[TaxRatesRetrieveRequestExpandItem, typing.Sequence[TaxRatesRetrieveRequestExpandItem]]
        ] = None,
        include_remote_data: typing.Optional[bool] = None,
        include_shell_data: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        expand : typing.Optional[typing.Union[TaxRatesRetrieveRequestExpandItem, typing.Sequence[TaxRatesRetrieveRequestExpandItem]]]
            Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces.
...
class AsyncTaxRatesClient:
    ...
    async def list(
        ...
        *,
        ...
        remote_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncPager[TaxRate, PaginatedTaxRateList]:
        """
        Returns a list of `TaxRate` objects.
        ...
        async def main() -> None:
            response = await client.accounting.tax_rates.list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            )
