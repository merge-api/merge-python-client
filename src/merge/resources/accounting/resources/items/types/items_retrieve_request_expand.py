...
class ItemsRetrieveRequestExpand(str, enum.Enum):
    ...
    def visit(
        ...
        if self is ItemsRetrieveRequestExpand.COMPANY:
            return company()
        if self is ItemsRetrieveRequestExpand.COMPANY_PURCHASE_TAX_RATE:
            return company_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.COMPANY_SALES_TAX_RATE:
            return company_sales_tax_rate()
        if self is ItemsRetrieveRequestExpand.COMPANY_SALES_TAX_RATE_PURCHASE_TAX_RATE:
        ...
        if self is ItemsRetrieveRequestExpand.PURCHASE_ACCOUNT_COMPANY_PURCHASE_TAX_RATE:
            return purchase_account_company_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.PURCHASE_ACCOUNT_COMPANY_SALES_TAX_RATE:
            return purchase_account_company_sales_tax_rate()
        if self is ItemsRetrieveRequestExpand.PURCHASE_ACCOUNT_COMPANY_SALES_TAX_RATE_PURCHASE_TAX_RATE:
            return purchase_account_company_sales_tax_rate_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.PURCHASE_ACCOUNT_PURCHASE_TAX_RATE:
        ...
        if self is ItemsRetrieveRequestExpand.PURCHASE_ACCOUNT_SALES_ACCOUNT_COMPANY_PURCHASE_TAX_RATE:
        ...
        if self is ItemsRetrieveRequestExpand.PURCHASE_ACCOUNT_SALES_ACCOUNT_COMPANY_SALES_TAX_RATE_PURCHASE_TAX_RATE:
            return purchase_account_sales_account_company_sales_tax_rate_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.PURCHASE_ACCOUNT_SALES_ACCOUNT_PURCHASE_TAX_RATE:
            return purchase_account_sales_account_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.PURCHASE_ACCOUNT_SALES_ACCOUNT_SALES_TAX_RATE:
        ...
        if self is ItemsRetrieveRequestExpand.PURCHASE_TAX_RATE:
        ...
        if self is ItemsRetrieveRequestExpand.SALES_ACCOUNT_COMPANY_PURCHASE_TAX_RATE:
            return sales_account_company_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.SALES_ACCOUNT_COMPANY_SALES_TAX_RATE:
            return sales_account_company_sales_tax_rate()
        if self is ItemsRetrieveRequestExpand.SALES_ACCOUNT_COMPANY_SALES_TAX_RATE_PURCHASE_TAX_RATE:
            return sales_account_company_sales_tax_rate_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.SALES_ACCOUNT_PURCHASE_TAX_RATE:
            return sales_account_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.SALES_ACCOUNT_SALES_TAX_RATE:
            return sales_account_sales_tax_rate()
        if self is ItemsRetrieveRequestExpand.SALES_ACCOUNT_SALES_TAX_RATE_PURCHASE_TAX_RATE:
            return sales_account_sales_tax_rate_purchase_tax_rate()
        if self is ItemsRetrieveRequestExpand.SALES_TAX_RATE:
            return sales_tax_rate()
        if self is ItemsRetrieveRequestExpand.SALES_TAX_RATE_PURCHASE_TAX_RATE:
