...
_dynamic_imports: typing.Dict[str, str] = {
    "JournalEntriesListRequestExpandItem": ".journal_entries_list_request_expand_item",
    "JournalEntriesRetrieveRequestExpandItem": ".journal_entries_retrieve_request_expand_item",
}
