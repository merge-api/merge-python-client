...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "InvoicesListRequestRemoteFields": ".types",
    "InvoicesListRequestShowEnumOrigins": ".types",
    "InvoicesListRequestStatus": ".types",
    "InvoicesListRequestType": ".types",
    "InvoicesRetrieveRequestExpandItem": ".types",
    "InvoicesRetrieveRequestRemoteFields": ".types",
    "InvoicesRetrieveRequestShowEnumOrigins": ".types",
}
