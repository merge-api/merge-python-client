...
from ...types.sales_order import SalesOrder
from ...types.sales_order_batch_item_request import SalesOrderBatchItemRequest
from ...types.sales_order_request_request import SalesOrderRequestRequest
from ...types.sales_order_response import SalesOrderResponse
from .raw_client import AsyncRawSalesOrdersClient, RawSalesOrdersClient
from .types.sales_orders_list_request_expand_item import SalesOrdersListRequestExpandItem
from .types.sales_orders_retrieve_request_expand_item import SalesOrdersRetrieveRequestExpandItem
...
class SalesOrdersClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawSalesOrdersClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawSalesOrdersClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        RawSalesOrdersClient
        """
    ...
    def list(
        ...
        *,
        ...
        expand: typing.Optional[
            typing.Union[SalesOrdersListRequestExpandItem, typing.Sequence[SalesOrdersListRequestExpandItem]]
        ] = None,
        ...
        expand : typing.Optional[typing.Union[SalesOrdersListRequestExpandItem, typing.Sequence[SalesOrdersListRequestExpandItem]]]
    ...
    def retrieve(
        ...
        *,
        expand: typing.Optional[
            typing.Union[SalesOrdersRetrieveRequestExpandItem, typing.Sequence[SalesOrdersRetrieveRequestExpandItem]]
        ] = None,
        include_remote_data: typing.Optional[bool] = None,
        include_remote_fields: typing.Optional[bool] = None,
        include_shell_data: typing.Optional[bool] = None,
        ...
        expand : typing.Optional[typing.Union[SalesOrdersRetrieveRequestExpandItem, typing.Sequence[SalesOrdersRetrieveRequestExpandItem]]]
            Which relations should be returned in expanded form. Multiple relation names should be comma separated without spaces.
...
class AsyncSalesOrdersClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawSalesOrdersClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawSalesOrdersClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawSalesOrdersClient
        """
        return self._raw_client
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.accounting.sales_orders.list(
                company_id="company_id",
                created_after=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.accounting.sales_orders.create(
                is_debug_mode=True,
                run_async=True,
                model=SalesOrderRequestRequest(),
            )
    ...
    async def retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.accounting.sales_orders.retrieve(
                id="id",
                include_remote_data=True,
                include_remote_fields=True,
                include_shell_data=True,
    ...
    async def bulk_create(
        ...
        *,
        ...
        async def main() -> None:
            await client.accounting.sales_orders.bulk_create(
                batch_items=[
                    SalesOrderBatchItemRequest(
                        item_id="item_id",
                        payload=SalesOrderRequestRequest(),
    ...
    async def bulk_retrieve(
        ...
        async def main() -> None:
            await client.accounting.sales_orders.bulk_retrieve(
                batch_id="batch_id",
            )
    ...
    async def lines_remote_field_classes_list(
        ...
        *,
        ...
        async def main() -> None:
            response = (
                await client.accounting.sales_orders.lines_remote_field_classes_list(
                    cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
                    include_deleted_data=True,
                    include_remote_data=True,
                    include_shell_data=True,
    ...
    async def meta_post_retrieve(self, *, request_options: typing.Optional[RequestOptions] = None) -> MetaResponse:
        ...
        async def main() -> None:
            await client.accounting.sales_orders.meta_post_retrieve()
    ...
    async def remote_field_classes_list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.accounting.sales_orders.remote_field_classes_list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
                include_deleted_data=True,
                include_remote_data=True,
                include_shell_data=True,
