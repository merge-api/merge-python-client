...
from ...types.paginated_sales_order_list import PaginatedSalesOrderList
...
class AsyncSalesOrdersClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.accounting.sales_orders.list(
                company_id="company_id",
                created_after=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
    ...
    async def remote_field_classes_list(
        ...
        *,
        ...
        async def main() -> None:
            await client.accounting.sales_orders.remote_field_classes_list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
                include_deleted_data=True,
                include_remote_data=True,
                include_shell_data=True,
