...
class RawSalesOrdersClient:
    ...
    ) -> HttpResponse[PaginatedSalesOrderList]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=PaginatedSalesOrderList,  # type: ignore
    ...
    def create(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[SalesOrderResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    SalesOrderResponse,
                    construct_type(
                        type_=SalesOrderResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def retrieve(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"accounting/v1/sales-orders/{jsonable_encoder(id)}",
            method="GET",
            params={
                "expand": expand,
                "include_remote_data": include_remote_data,
    ...
    def bulk_retrieve(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"accounting/v1/sales-orders/bulk/{jsonable_encoder(batch_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawSalesOrdersClient:
    ...
    async def list(
        ...
        *,
        ...
        show_enum_origins: typing.Optional[typing.Literal["status"]] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PaginatedSalesOrderList]:
        """
        Returns a list of `SalesOrder` objects.
    ...
    async def create(
        ...
        *,
        ...
        run_async: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[SalesOrderResponse]:
        """
        Creates a `SalesOrder` object with the given values.
