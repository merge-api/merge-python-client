...
class ExpensesRetrieveRequestExpand(str, enum.Enum):
    ...
    def visit(
        ...
        if self is ExpensesRetrieveRequestExpand.ACCOUNT_COMPANY_EMPLOYEE:
            return account_company_employee()
        if self is ExpensesRetrieveRequestExpand.ACCOUNT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD:
        ...
        if self is ExpensesRetrieveRequestExpand.ACCOUNT_CONTACT_COMPANY_EMPLOYEE:
            return account_contact_company_employee()
        if self is ExpensesRetrieveRequestExpand.ACCOUNT_CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD:
            return account_contact_company_employee_accounting_period()
        if self is ExpensesRetrieveRequestExpand.ACCOUNT_CONTACT_EMPLOYEE:
            return account_contact_employee()
        if self is ExpensesRetrieveRequestExpand.ACCOUNT_CONTACT_EMPLOYEE_ACCOUNTING_PERIOD:
            return account_contact_employee_accounting_period()
        if self is ExpensesRetrieveRequestExpand.ACCOUNT_EMPLOYEE:
            return account_employee()
        if self is ExpensesRetrieveRequestExpand.ACCOUNT_EMPLOYEE_ACCOUNTING_PERIOD:
        ...
        if self is ExpensesRetrieveRequestExpand.COMPANY_EMPLOYEE:
            return company_employee()
        if self is ExpensesRetrieveRequestExpand.COMPANY_EMPLOYEE_ACCOUNTING_PERIOD:
        ...
        if self is ExpensesRetrieveRequestExpand.CONTACT_COMPANY_EMPLOYEE:
            return contact_company_employee()
        if self is ExpensesRetrieveRequestExpand.CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD:
            return contact_company_employee_accounting_period()
        if self is ExpensesRetrieveRequestExpand.CONTACT_EMPLOYEE:
            return contact_employee()
        if self is ExpensesRetrieveRequestExpand.CONTACT_EMPLOYEE_ACCOUNTING_PERIOD:
            return contact_employee_accounting_period()
        if self is ExpensesRetrieveRequestExpand.EMPLOYEE:
            return employee()
        if self is ExpensesRetrieveRequestExpand.EMPLOYEE_ACCOUNTING_PERIOD:
        ...
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_ACCOUNT_COMPANY_EMPLOYEE:
            return tracking_categories_account_company_employee()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_ACCOUNT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD:
        ...
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_ACCOUNT_CONTACT_COMPANY_EMPLOYEE:
            return tracking_categories_account_contact_company_employee()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_ACCOUNT_CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD:
            return tracking_categories_account_contact_company_employee_accounting_period()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_ACCOUNT_CONTACT_EMPLOYEE:
            return tracking_categories_account_contact_employee()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_ACCOUNT_CONTACT_EMPLOYEE_ACCOUNTING_PERIOD:
        ...
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_COMPANY_EMPLOYEE:
            return tracking_categories_company_employee()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD:
        ...
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_CONTACT_COMPANY_EMPLOYEE:
            return tracking_categories_contact_company_employee()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_CONTACT_COMPANY_EMPLOYEE_ACCOUNTING_PERIOD:
            return tracking_categories_contact_company_employee_accounting_period()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_CONTACT_EMPLOYEE:
            return tracking_categories_contact_employee()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_CONTACT_EMPLOYEE_ACCOUNTING_PERIOD:
            return tracking_categories_contact_employee_accounting_period()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_EMPLOYEE:
            return tracking_categories_employee()
        if self is ExpensesRetrieveRequestExpand.TRACKING_CATEGORIES_EMPLOYEE_ACCOUNTING_PERIOD:
