...
class Transactions(SyncAPIResource):
    def retrieve(
        ...
        *,
        ...
        """
        return self._get(
            f"/accounting/v1/transactions/{id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    transaction_retrieve_params.TransactionRetrieveParams,
                ),
            ),
            cast_to=Transaction,
        )
    ...
    def list(
        ...
        *,
        ...
        Args:
          company_id: If provided, will only return accounting transactions for this company.
