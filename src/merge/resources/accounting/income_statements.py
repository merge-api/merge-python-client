...
from ...types.accounting import (
    IncomeStatement,
    income_statement_list_params,
    income_statement_retrieve_params,
)

__all__ = ["IncomeStatements", "AsyncIncomeStatements"]


class IncomeStatements(SyncAPIResource):
    def retrieve(
        self,
        id: str,
        *,
        ...
        """
        return self._get(
            f"/accounting/v1/income-statements/{id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    income_statement_retrieve_params.IncomeStatementRetrieveParams,
                ),
            ),
            cast_to=IncomeStatement,
        )
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> SyncPage[IncomeStatement]:
        """
        Returns a list of `IncomeStatement` objects.

        Args:
          company_id: If provided, will only return income statements for this company.
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    income_statement_list_params.IncomeStatementListParams,
                ),
            ),
...
class AsyncIncomeStatements(AsyncAPIResource):
    async def retrieve(
        self,
        id: str,
        *,
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[IncomeStatement, AsyncPage[IncomeStatement]]:
        """
        Returns a list of `IncomeStatement` objects.
        ...
        return self._get_api_list(
            "/accounting/v1/income-statements",
            page=AsyncPage[IncomeStatement],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
