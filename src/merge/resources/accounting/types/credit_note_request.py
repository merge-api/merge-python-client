...
class CreditNoteRequest(UncheckedBaseModel):
    ...
    status: typing.Optional[CreditNoteRequestStatus] = pydantic.Field(default=None)
    """
    ...
    * `PAID` - PAID
    ...
    contact: typing.Optional[CreditNoteRequestContact] = pydantic.Field(default=None)
    """
    The credit note's contact.
    """

    company: typing.Optional[CreditNoteRequestCompany] = pydantic.Field(default=None)
    """
    ...
    line_items: typing.Optional[typing.List[CreditNoteRequestLineItemsItem]] = None
    tracking_categories: typing.Optional[typing.List[typing.Optional[CreditNoteRequestTrackingCategoriesItem]]] = None
    currency: typing.Optional[CreditNoteRequestCurrency] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    applied_payments: typing.Optional[typing.List[typing.Optional[CreditNoteRequestAppliedPaymentsItem]]] = (
    ...
    accounting_period: typing.Optional[CreditNoteRequestAccountingPeriod] = pydantic.Field(default=None)
    """
    The accounting period that the CreditNote was generated in.
    """

    applied_to_lines: typing.Optional[typing.List[CreditNoteApplyLineForCreditNoteRequest]] = pydantic.Field(
        default=None
    )
    """
