...
class GeneralLedgerTransactionLine(UncheckedBaseModel):
    ...
    account: typing.Optional[GeneralLedgerTransactionLineAccount] = None
    company: typing.Optional[GeneralLedgerTransactionLineCompany] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    transaction_currency: typing.Optional[TransactionCurrencyEnum] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    foreign_debit_amount: str
    foreign_credit_amount: str
