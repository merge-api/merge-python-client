...
class Account(UncheckedBaseModel):
    ...
    * __Expense:__ Cost of Goods Sold and Office Expenses
    ...
    classification: typing.Optional[AccountClassification] = pydantic.Field(default=None)
    """
    ...
    * `REVENUE` - REVENUE
    ...
    account_type: typing.Optional[AccountAccountType] = pydantic.Field(default=None)
    """
    ...
    * `INACTIVE` - INACTIVE
    ...
    currency: typing.Optional[AccountCurrency] = pydantic.Field(default=None)
    """
