...
class PurchaseOrderLineItem(pydantic.BaseModel):
    ...
    tax_amount: typing.Optional[str] = pydantic.Field(description="The purchase order line item's tax amount.")
    total_line_amount: typing.Optional[str] = pydantic.Field(description="The purchase order line item's total amount.")
