...
class BankFeedAccount(UncheckedBaseModel):
    ...
    source_account_name: typing.Optional[str] = pydantic.Field(default=None)
    """
    The name of the source account as stored in our customer’s platform.
    """

    source_account_number: typing.Optional[str] = pydantic.Field(default=None)
    """
    The human-readable account number of the source account as stored in our customer’s platform.
    """

    target_account_name: typing.Optional[str] = pydantic.Field(default=None)
    """
    The name of the target account from the third party software.
    """

    currency: typing.Optional[BankFeedAccountCurrency] = pydantic.Field(default=None)
    """
    ...
    * `INACTIVE` - INACTIVE
    ...
    source_account_balance: typing.Optional[float] = pydantic.Field(default=None)
    """
    The current balance of funds in the source account.
    """

    account_type: typing.Optional[BankFeedAccountAccountType] = pydantic.Field(default=None)
    """
    ...
    * `CREDIT_CARD` - CREDIT_CARD
    ...
    remote_data: typing.Optional[typing.List[typing.Optional[typing.Dict[str, typing.Any]]]] = None
