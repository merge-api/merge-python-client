...
class BalanceSheet(UncheckedBaseModel):
    ...
    currency: typing.Optional[BalanceSheetCurrency] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    net_assets: typing.Optional[float] = pydantic.Field(default=None)
    """
    The balance sheet's net assets.
    """

    assets: typing.Optional[typing.List[ReportItem]] = None
    liabilities: typing.Optional[typing.List[ReportItem]] = None
    equity: typing.Optional[typing.List[ReportItem]] = None
