...
class ExpenseReport(UncheckedBaseModel):
    """
    ...
    status: typing.Optional[ExpenseReportStatus] = pydantic.Field(default=None)
    """
    ...
    * `REJECTED` - REJECTED
    ...
    lines: typing.Optional[typing.List[ExpenseReportLinesItem]] = None
    currency: typing.Optional[ExpenseReportCurrency] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    company: typing.Optional[ExpenseReportCompany] = pydantic.Field(default=None)
    """
