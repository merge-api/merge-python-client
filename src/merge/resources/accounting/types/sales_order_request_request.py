...
class SalesOrderRequestRequest(UncheckedBaseModel):
    """
    ...
    customer: typing.Optional[SalesOrderRequestRequestCustomer] = pydantic.Field(default=None)
    """
    The customer associated with the sales order.
    """

    currency: typing.Optional[SalesOrderRequestRequestCurrency] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    company: typing.Optional[SalesOrderRequestRequestCompany] = pydantic.Field(default=None)
    """
    The subsidiary associated with the order.
    """

    status: typing.Optional[SalesOrderRequestRequestStatus] = pydantic.Field(default=None)
    """
    ...
    * `CLOSED` - CLOSED
    ...
    payment_term: typing.Optional[SalesOrderRequestRequestPaymentTerm] = pydantic.Field(default=None)
    """
    ...
    shipping_address: typing.Optional[SalesOrderRequestRequestShippingAddress] = pydantic.Field(default=None)
    """
    The shipping address for the order.
    """

    tracking_categories: typing.Optional[
        typing.List[typing.Optional[SalesOrderRequestRequestTrackingCategoriesItem]]
    ] = None
    ...
    transaction_number: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    lines: typing.Optional[typing.List[SalesOrderRequestRequestLinesItem]] = None
