...
class SalesOrder(UncheckedBaseModel):
    """
    ...
    customer: typing.Optional[SalesOrderCustomer] = pydantic.Field(default=None)
    """
    The customer associated with the sales order.
    """

    currency: typing.Optional[SalesOrderCurrency] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    company: typing.Optional[SalesOrderCompany] = pydantic.Field(default=None)
    """
    ...
    * `CLOSED` - CLOSED
    ...
    payment_term: typing.Optional[SalesOrderPaymentTerm] = pydantic.Field(default=None)
    """
    ...
    shipping_address: typing.Optional[SalesOrderShippingAddress] = pydantic.Field(default=None)
    """
    The shipping address for the order.
    """

    tracking_categories: typing.Optional[typing.List[typing.Optional[SalesOrderTrackingCategoriesItem]]] = None
    ...
    lines: typing.Optional[typing.List[SalesOrderLinesItem]] = None
