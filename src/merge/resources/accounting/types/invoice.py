...
class Invoice(UncheckedBaseModel):
    ...
    * `ACCOUNTS_PAYABLE` - ACCOUNTS_PAYABLE
    ...
    employee: typing.Optional[InvoiceEmployee] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    status: typing.Optional[InvoiceStatusEnum] = pydantic.Field(default=None)
    """
    ...
    * `VOID` - VOID
    ...
    applied_vendor_credits: typing.Optional[typing.List["InvoiceAppliedVendorCreditsItem"]] = pydantic.Field(
        default=None
    )
    """
