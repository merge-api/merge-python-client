...
class AccountRequest(UncheckedBaseModel):
    ...
    * __Expense:__ Cost of Goods Sold and Office Expenses
    ...
    classification: typing.Optional[ClassificationEnum] = pydantic.Field(default=None)
    """
    ...
    * `REVENUE` - REVENUE
    ...
    account_type: typing.Optional[AccountAccountTypeEnum] = pydantic.Field(default=None)
    """
    ...
    * `NON_POSTING` - NON_POSTING
    ...
    status: typing.Optional[AccountStatusEnum] = pydantic.Field(default=None)
    """
