...
class BankFeedAccountRequest(UncheckedBaseModel):
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    feed_status: typing.Optional[FeedStatusEnum] = pydantic.Field(default=None)
    """
    ...
    * `INACTIVE` - INACTIVE
    ...
    account_type: typing.Optional[BankFeedAccountAccountTypeEnum] = pydantic.Field(default=None)
    """
