...
class BankFeedAccountRequest(UncheckedBaseModel):
    ...
    currency: typing.Optional[BankFeedAccountRequestCurrency] = pydantic.Field(default=None)
    """
    ...
    * `INACTIVE` - INACTIVE
    ...
    account_type: typing.Optional[BankFeedAccountRequestAccountType] = pydantic.Field(default=None)
    """
