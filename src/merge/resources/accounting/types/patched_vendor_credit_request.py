...
class PatchedVendorCreditRequest(UncheckedBaseModel):
    """
    ...
    vendor: typing.Optional[PatchedVendorCreditRequestVendor] = pydantic.Field(default=None)
    """
    The vendor that owes the gift or refund.
    """

    currency: typing.Optional[PatchedVendorCreditRequestCurrency] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    company: typing.Optional[PatchedVendorCreditRequestCompany] = pydantic.Field(default=None)
    """
