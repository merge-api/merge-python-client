...
class VendorCreditRequest(UncheckedBaseModel):
    ...
    vendor: typing.Optional[VendorCreditRequestVendor] = pydantic.Field(default=None)
    """
    ...
    currency: typing.Optional[VendorCreditRequestCurrency] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    company: typing.Optional[VendorCreditRequestCompany] = pydantic.Field(default=None)
    """
    The company the vendor credit belongs to.
    """

    tracking_categories: typing.Optional[typing.List[typing.Optional[VendorCreditRequestTrackingCategoriesItem]]] = None
    applied_to_lines: typing.Optional[typing.List[VendorCreditApplyLineForVendorCreditRequest]] = pydantic.Field(
        default=None
    )
    """
    ...
    accounting_period: typing.Optional[VendorCreditRequestAccountingPeriod] = pydantic.Field(default=None)
    """
...
update_forward_refs(VendorCreditRequest)
