...
class ScopesClient:
    ...
    def default_scopes_retrieve(
        ...
        client.calendar.scopes.default_scopes_retrieve()
        """
    ...
    def linked_account_scopes_retrieve(
        ...
        client.calendar.scopes.linked_account_scopes_retrieve()
        """
    ...
    def linked_account_scopes_create(
        ...
        *,
        ...
        --------
        from merge import Merge
        from merge.resources.calendar import (
        ...
        client.calendar.scopes.linked_account_scopes_create(
            common_models=[
                IndividualCommonModelScopeDeserializerRequest(
                    model_name="Employee",
                    model_permissions={
...
class AsyncScopesClient:
    ...
    async def default_scopes_retrieve(
        ...
        async def main() -> None:
            await client.calendar.scopes.default_scopes_retrieve()
    ...
    async def linked_account_scopes_retrieve(
        ...
        async def main() -> None:
            await client.calendar.scopes.linked_account_scopes_retrieve()
    ...
    async def linked_account_scopes_create(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.scopes.linked_account_scopes_create(
                common_models=[
                    IndividualCommonModelScopeDeserializerRequest(
                        model_name="Employee",
                        model_permissions={
