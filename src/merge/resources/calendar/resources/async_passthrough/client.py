...
class AsyncPassthroughClient:
    ...
    def create(
        ...
        from merge.resources.calendar import DataPassthroughRequest, MethodEnum

        client = Merge(
            account_token="YOUR_ACCOUNT_TOKEN",
            api_key="YOUR_API_KEY",
        )
        client.calendar.async_passthrough.create(
            request=DataPassthroughRequest(
    ...
    def retrieve(
        ...
        client.calendar.async_passthrough.retrieve(
...
class AsyncAsyncPassthroughClient:
    ...
    async def create(
        ...
        async def main() -> None:
            await client.calendar.async_passthrough.create(
                request=DataPassthroughRequest(
                    method=MethodEnum.GET,
                    path="/scooters",
                ),
    ...
    async def retrieve(
        ...
        async def main() -> None:
            await client.calendar.async_passthrough.retrieve(
                async_passthrough_receipt_id="async_passthrough_receipt_id",
            )
