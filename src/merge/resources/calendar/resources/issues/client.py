...
class IssuesClient:
    ...
    def list(
        ...
        *,
        ...
        from merge.resources.calendar.resources.issues import IssuesListRequestStatus

        client = Merge(
            account_token="YOUR_ACCOUNT_TOKEN",
            api_key="YOUR_API_KEY",
        )
        client.calendar.issues.list(
    ...
    def retrieve(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Issue:
        ...
        client.calendar.issues.retrieve(
            id="id",
        )
        """
...
class AsyncIssuesClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.issues.list(
                account_token="account_token",
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
                end_date="end_date",
                end_user_organization_name="end_user_organization_name",
    ...
    async def retrieve(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Issue:
        ...
        async def main() -> None:
            await client.calendar.issues.retrieve(
                id="id",
            )
