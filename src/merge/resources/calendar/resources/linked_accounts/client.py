...
class LinkedAccountsClient:
    ...
    def list(
        ...
        *,
        ...
        from merge.resources.calendar.resources.linked_accounts import (
        ...
        client.calendar.linked_accounts.list(
    ...
    def partial_update(
        ...
        *,
        ...
        client.calendar.linked_accounts.partial_update(
...
class AsyncLinkedAccountsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.linked_accounts.list(
                category=LinkedAccountsListRequestCategory.ACCOUNTING,
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
                end_user_email_address="end_user_email_address",
                end_user_organization_name="end_user_organization_name",
    ...
    async def partial_update(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.linked_accounts.partial_update(
                linked_account_id="linked_account_id",
            )
