...
class WebhookReceiversClient:
    ...
    def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[WebhookReceiver]:
        ...
        client.calendar.webhook_receivers.list()
        """
    ...
    def create(
        ...
        *,
        ...
        client.calendar.webhook_receivers.create(
            event="event",
            is_active=True,
        )
        """
...
class AsyncWebhookReceiversClient:
    ...
    async def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[WebhookReceiver]:
        ...
        async def main() -> None:
            await client.calendar.webhook_receivers.list()
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.webhook_receivers.create(
                event="event",
                is_active=True,
            )
