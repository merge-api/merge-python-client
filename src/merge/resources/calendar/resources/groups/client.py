...
class GroupsClient:
    ...
    def list(
        self,
        *,
        child_group_id: typing.Optional[str] = None,
        ...
        Parameters
        ----------
        child_group_id : typing.Optional[str]
            If provided, will only return Groups containing this child Group.
        ...
        email_address : typing.Optional[str]
            If provided, will only return Groups with this email address.
        ...
        name : typing.Optional[str]
            If provided, will only return Groups with this name.
    ...
    def retrieve(
        ...
        *,
        ...
        client.calendar.groups.retrieve(
            id="id",
            include_remote_data=True,
            include_shell_data=True,
        )
...
class AsyncGroupsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.groups.list(
                child_group_id="child_group_id",
                created_after=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
    ...
    async def retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.groups.retrieve(
                id="id",
                include_remote_data=True,
                include_shell_data=True,
            )
