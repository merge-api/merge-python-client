...
class FieldMappingClient:
    ...
    def field_mappings_retrieve(
        ...
        *,
        ...
        client.calendar.field_mapping.field_mappings_retrieve(
    ...
    def field_mappings_create(
        ...
        *,
        ...
        client.calendar.field_mapping.field_mappings_create(
            exclude_remote_field_metadata=True,
    ...
    def field_mappings_destroy(
        ...
        client.calendar.field_mapping.field_mappings_destroy(
    ...
    def field_mappings_partial_update(
        ...
        *,
        ...
        client.calendar.field_mapping.field_mappings_partial_update(
            field_mapping_id="field_mapping_id",
            remote_data_iteration_count=1,
        )
        """
    ...
    def remote_fields_retrieve(
        ...
        *,
        ...
        client.calendar.field_mapping.remote_fields_retrieve(
    ...
    def target_fields_retrieve(
        ...
        client.calendar.field_mapping.target_fields_retrieve()
        """
    ...
    def target_fields_create(
        ...
        *,
        ...
        client.calendar.field_mapping.target_fields_create(
...
class AsyncFieldMappingClient:
    ...
    async def field_mappings_retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.field_mapping.field_mappings_retrieve(
                exclude_remote_field_metadata=True,
            )
    ...
    async def field_mappings_create(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.field_mapping.field_mappings_create(
                exclude_remote_field_metadata=True,
                remote_data_iteration_count=1,
                remote_field_traversal_path=["example_remote_field"],
                remote_method="GET",
    ...
    async def field_mappings_destroy(
        ...
        async def main() -> None:
            await client.calendar.field_mapping.field_mappings_destroy(
                field_mapping_id="field_mapping_id",
            )
    ...
    async def field_mappings_partial_update(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.field_mapping.field_mappings_partial_update(
                field_mapping_id="field_mapping_id",
                remote_data_iteration_count=1,
            )
    ...
    async def remote_fields_retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.field_mapping.remote_fields_retrieve(
                common_models="common_models",
                include_example_values="include_example_values",
            )
    ...
    async def target_fields_retrieve(
        ...
        async def main() -> None:
            await client.calendar.field_mapping.target_fields_retrieve()
    ...
    async def target_fields_create(
        ...
        *,
        ...
        async def main() -> None:
            await client.calendar.field_mapping.target_fields_create(
                name="employee_favorite_team",
                common_model="Employee",
            )
