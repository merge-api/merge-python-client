...
class Group(UncheckedBaseModel):
    ...
    # The Group Object
    ### Description
    The `Group` object is a collection of users in the third-party calendar system.
    ### Usage Example
    Fetch from the `GET /api/calendar/v1/groups` endpoint and view their groups.
    """
    ...
    child_groups: typing.Optional[typing.List[typing.Optional[str]]] = None
