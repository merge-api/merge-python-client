...
class ExternalTargetFieldApiResponse(UncheckedBaseModel):
    calendar: typing.Optional[typing.List[ExternalTargetFieldApi]] = pydantic.Field(alias="Calendar", default=None)
    ...
    series: typing.Optional[typing.List[ExternalTargetFieldApi]] = pydantic.Field(alias="Series", default=None)
    event: typing.Optional[typing.List[ExternalTargetFieldApi]] = pydantic.Field(alias="Event", default=None)
