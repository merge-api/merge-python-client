...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CalendarTypeEnum": ".calendar_type_enum",
    ...
    "PermissionEffectiveRole": ".permission_effective_role",
