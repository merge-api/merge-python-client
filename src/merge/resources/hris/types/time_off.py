...
class TimeOff(UncheckedBaseModel):
    ...
    status: typing.Optional[TimeOffStatusEnum] = pydantic.Field(default=None)
    """
    ...
    * `DELETED` - DELETED
    ...
    units: typing.Optional[UnitsEnum] = pydantic.Field(default=None)
    """
    ...
    * `DAYS` - DAYS
    ...
    request_type: typing.Optional[RequestTypeEnum] = pydantic.Field(default=None)
    """
