...
class Employment(pydantic.BaseModel):
    ...
    pay_group: typing.Optional[EmploymentPayGroup] = pydantic.Field(description="The employment's pay group")
    ...
    effective_date: typing.Optional[dt.datetime] = pydantic.Field(description="The position's effective date.")
