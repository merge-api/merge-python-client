...
class Employment(UncheckedBaseModel):
    ...
    pay_period: typing.Optional[PayPeriodEnum] = pydantic.Field(default=None)
    """
    ...
    * `YEAR` - YEAR
    ...
    pay_frequency: typing.Optional[PayFrequencyEnum] = pydantic.Field(default=None)
    """
    ...
    * `SEMIMONTHLY` - SEMIMONTHLY
    ...
    pay_currency: typing.Optional[PayCurrencyEnum] = pydantic.Field(default=None)
    """
    ...
    * `ZWL` - Zimbabwean Dollar (2009)
    ...
    flsa_status: typing.Optional[FlsaStatusEnum] = pydantic.Field(default=None)
    """
    ...
    * `OWNER` - OWNER
    ...
    employment_type: typing.Optional[EmploymentTypeEnum] = pydantic.Field(default=None)
    """
...
from .employment_employee import EmploymentEmployee  # noqa: E402, F401, I001
