...
class EmployeeRequest(UncheckedBaseModel):
    ...
    gender: typing.Optional[GenderEnum] = pydantic.Field(default=None)
    """
    ...
    * `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
    ...
    ethnicity: typing.Optional[EthnicityEnum] = pydantic.Field(default=None)
    """
    ...
    * `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
    ...
    marital_status: typing.Optional[MaritalStatusEnum] = pydantic.Field(default=None)
    """
    ...
    * `QUALIFYING_WIDOW_OR_WIDOWER_WITH_DEPENDENT_CHILD` - QUALIFYING_WIDOW_OR_WIDOWER_WITH_DEPENDENT_CHILD
    ...
    employment_status: typing.Optional[EmploymentStatusEnum] = pydantic.Field(default=None)
    """
...
update_forward_refs(EmployeeRequest)
