...
class EmployerBenefitsClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment.value}/", "api/hris/v1/employer-benefits"),
    ...
    def retrieve(self, id: str, *, include_remote_data: typing.Optional[bool] = None) -> EmployerBenefit:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment.value}/", f"api/hris/v1/employer-benefits/{id}"),
