...
class EmployerBenefitsClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "employer-benefits"),
    ...
    def retrieve(self, id: str, *, include_remote_data: typing.Optional[bool] = None) -> EmployerBenefit:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"employer-benefits/{id}"),
