...
class RawEmployeesClient:
    ...
    ) -> SyncPager[Employee, PaginatedEmployeeList]:
        """
    ...
    def retrieve(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"employees/{jsonable_encoder(id)}",
            method="GET",
            params={
                "expand": expand,
                "include_remote_data": include_remote_data,
    ...
    def ignore_create(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"employees/ignore/{jsonable_encoder(model_id)}",
            method="POST",
            json=request,
            headers={
                "content-type": "application/json",
...
class AsyncRawEmployeesClient:
    ...
    async def list(
        ...
        *,
        ...
        work_location_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncPager[Employee, PaginatedEmployeeList]:
        """
        Returns a list of `Employee` objects.
