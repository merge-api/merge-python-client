...
from ...types.hris import PayGroup, pay_group_list_params, pay_group_retrieve_params
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"include_remote_data": include_remote_data}, pay_group_retrieve_params.PayGroupRetrieveParams
                ),
            ),
            cast_to=PayGroup,
        )
...
class AsyncPayGroups(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[PayGroup, AsyncPage[PayGroup]]:
        """
        Returns a list of `PayGroup` objects.
