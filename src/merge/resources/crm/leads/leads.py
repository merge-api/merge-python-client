...
from ....types.crm import (
    ...
    lead_list_params,
    lead_create_params,
    lead_retrieve_params,
    lead_list_remote_field_classes_params,
)
...
class Leads(SyncAPIResource):
    ...
    def create(
        self,
        *,
        model: lead_create_params.Model,
        ...
        return self._post(
            "/crm/v1/leads",
            body=maybe_transform({"model": model}, lead_create_params.LeadCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=LeadResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    lead_retrieve_params.LeadRetrieveParams,
                ),
            ),
            cast_to=Lead,
        )
    ...
    def list(
        self,
        *,
        converted_account_id: str | NotGiven = NOT_GIVEN,
        converted_contact_id: str | NotGiven = NOT_GIVEN,
        ...
        Args:
          converted_account_id: If provided, will only return leads with this account.

          converted_contact_id: If provided, will only return leads with this contact.
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    lead_list_remote_field_classes_params.LeadListRemoteFieldClassesParams,
                ),
            ),
...
class AsyncLeads(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Lead, AsyncPage[Lead]]:
        """
        Returns a list of `Lead` objects.
