...
class RemoteFieldApiResponse(UncheckedBaseModel):
    ...
    lead: typing_extensions.Annotated[
        typing.Optional[typing.List[RemoteFieldApi]], FieldMetadata(alias="Lead"), pydantic.Field(alias="Lead")
    ] = None
    note: typing_extensions.Annotated[
        typing.Optional[typing.List[RemoteFieldApi]], FieldMetadata(alias="Note"), pydantic.Field(alias="Note")
    ] = None
    ...
    stage: typing_extensions.Annotated[
        typing.Optional[typing.List[RemoteFieldApi]], FieldMetadata(alias="Stage"), pydantic.Field(alias="Stage")
    ] = None
    ...
    task: typing_extensions.Annotated[
        typing.Optional[typing.List[RemoteFieldApi]], FieldMetadata(alias="Task"), pydantic.Field(alias="Task")
    ] = None
