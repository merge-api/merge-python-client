...
class LeadsListRequestExpandItem(str, enum.Enum):
    ...
    def visit(
        ...
        if self is LeadsListRequestExpandItem.CONVERTED_ACCOUNT:
            return converted_account()
        if self is LeadsListRequestExpandItem.CONVERTED_CONTACT:
            return converted_contact()
        if self is LeadsListRequestExpandItem.OWNER:
            return owner()
