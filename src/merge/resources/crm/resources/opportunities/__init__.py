...
_dynamic_imports: typing.Dict[str, str] = {
    "OpportunitiesListRequestExpandItem": ".types",
    "OpportunitiesListRequestRemoteFields": ".types",
    "OpportunitiesListRequestShowEnumOrigins": ".types",
    "OpportunitiesListRequestStatus": ".types",
    "OpportunitiesRetrieveRequestExpandItem": ".types",
    "OpportunitiesRetrieveRequestRemoteFields": ".types",
    "OpportunitiesRetrieveRequestShowEnumOrigins": ".types",
}
