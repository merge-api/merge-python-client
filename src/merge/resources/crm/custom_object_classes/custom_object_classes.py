...
from ....types.crm import (
    CustomObjectClass,
    custom_object_class_list_params,
    custom_object_class_retrieve_params,
)
from ....pagination import SyncPage, AsyncPage
from ...._base_client import AsyncPaginator, make_request_options
from .association_types import AssociationTypes, AsyncAssociationTypes

if TYPE_CHECKING:
    from ...._client import Merge, AsyncMerge

__all__ = ["CustomObjectClasses", "AsyncCustomObjectClasses"]


class CustomObjectClasses(SyncAPIResource):
    association_types: AssociationTypes

    def __init__(self, client: Merge) -> None:
        super().__init__(client)
        self.association_types = AssociationTypes(client)

    def retrieve(
        self,
        id: str,
        *,
        expand: List[Literal["fields"]] | NotGiven = NOT_GIVEN,
        ...
        """
        return self._get(
            f"/crm/v1/custom-object-classes/{id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    custom_object_class_retrieve_params.CustomObjectClassRetrieveParams,
                ),
            ),
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            ...
            page=SyncPage[CustomObjectClass],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=maybe_transform(
                    ...
                    custom_object_class_list_params.CustomObjectClassListParams,
                ),
            ),
            model=CustomObjectClass,
        )


class AsyncCustomObjectClasses(AsyncAPIResource):
    association_types: AsyncAssociationTypes

    def __init__(self, client: AsyncMerge) -> None:
        super().__init__(client)
        self.association_types = AsyncAssociationTypes(client)
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[CustomObjectClass, AsyncPage[CustomObjectClass]]:
        """
        Returns a list of `CustomObjectClass` objects.
        ...
        return self._get_api_list(
            "/crm/v1/custom-object-classes",
            page=AsyncPage[CustomObjectClass],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
