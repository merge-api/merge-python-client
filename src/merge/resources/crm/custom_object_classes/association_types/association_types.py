...
__all__ = ["AssociationTypes", "AsyncAssociationTypes"]


class AssociationTypes(SyncAPIResource):
    meta: Meta
    ...
    def create(
        ...
        *,
        model: association_type_create_params.Model,
        ...
        return self._post(
            ...
            body=maybe_transform({"model": model}, association_type_create_params.AssociationTypeCreateParams),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    association_type_retrieve_params.AssociationTypeRetrieveParams,
                ),
            ),
            cast_to=AssociationType,
        )
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    association_type_list_params.AssociationTypeListParams,
                ),
            ),
...
class AsyncAssociationTypes(AsyncAPIResource):
    meta: AsyncMeta
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[AssociationType, AsyncPage[AssociationType]]:
        """
        Returns a list of `AssociationType` objects.
        ...
        return self._get_api_list(
            f"/crm/v1/custom-object-classes/{custom_object_class_id}/association-types",
            page=AsyncPage[AssociationType],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
