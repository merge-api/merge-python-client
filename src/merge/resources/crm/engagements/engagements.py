...
from ....types.crm import (
    ...
    engagement_retrieve_params,
    engagement_list_remote_field_classes_params,
)
...
__all__ = ["Engagements", "AsyncEngagements"]


class Engagements(SyncAPIResource):
    meta: Meta
    ...
    def create(
        self,
        *,
        model: engagement_create_params.Model,
        ...
        return self._post(
            "/crm/v1/engagements",
            body=maybe_transform({"model": model}, engagement_create_params.EngagementCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=EngagementResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    engagement_retrieve_params.EngagementRetrieveParams,
                ),
            ),
            cast_to=Engagement,
        )
    ...
    def update(
        ...
        id: str,
        *,
        model: engagement_update_params.Model,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._patch(
            f"/crm/v1/engagements/{id}",
            body=maybe_transform({"model": model}, engagement_update_params.EngagementUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=EngagementResponse,
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    engagement_list_remote_field_classes_params.EngagementListRemoteFieldClassesParams,
                ),
            ),
...
class AsyncEngagements(AsyncAPIResource):
    meta: AsyncMeta
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Engagement, AsyncPage[Engagement]]:
        """
        Returns a list of `Engagement` objects.
