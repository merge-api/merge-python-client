...
from ...types.ticketing import team_list_params, team_retrieve_params
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"include_remote_data": include_remote_data}, team_retrieve_params.TeamRetrieveParams
                ),
            ),
            cast_to=shared.Team,
        )
