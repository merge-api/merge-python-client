...
class Role(UncheckedBaseModel):
    ...
    ticket_actions: typing.Optional[typing.List[TicketActionsEnum]] = pydantic.Field(default=None)
    """
    ...
    ticket_access: typing.Optional[TicketAccessEnum] = pydantic.Field(default=None)
    """
