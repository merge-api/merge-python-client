...
class PatchedTicketRequest(UncheckedBaseModel):
    ...
    assignees: typing.Optional[typing.List[PatchedTicketRequestAssigneesItem]] = pydantic.Field(default=None)
    """
    ...
    assigned_teams: typing.Optional[typing.List[PatchedTicketRequestAssignedTeamsItem]] = pydantic.Field(default=None)
    """
    ...
    creator: typing.Optional[PatchedTicketRequestCreator] = pydantic.Field(default=None)
    """
    ...
    * `ON_HOLD` - ON_HOLD
    ...
    collections: typing.Optional[typing.List[PatchedTicketRequestCollectionsItem]] = pydantic.Field(default=None)
    """
    ...
    account: typing.Optional[PatchedTicketRequestAccount] = pydantic.Field(default=None)
    """
    The account associated with the ticket.
    """

    contact: typing.Optional[PatchedTicketRequestContact] = pydantic.Field(default=None)
    """
    The contact associated with the ticket.
    """

    parent_ticket: typing.Optional[PatchedTicketRequestParentTicket] = pydantic.Field(default=None)
    """
