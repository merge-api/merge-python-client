...
class TicketsListRequestExpand(str, enum.Enum):
    ...
    def visit(
        ...
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS:
            return assigned_teams()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_ACCOUNT:
            return assigned_teams_account()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_ACCOUNT_CONTACT:
            return assigned_teams_account_contact()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR:
            return assigned_teams_account_contact_creator()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET:
            return assigned_teams_account_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET:
            return assigned_teams_account_contact_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_ACCOUNT_CREATOR:
            return assigned_teams_account_creator()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_CONTACT:
            return assigned_teams_contact()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_CONTACT_CREATOR:
            return assigned_teams_contact_creator()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET:
            return assigned_teams_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_CONTACT_PARENT_TICKET:
            return assigned_teams_contact_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_CREATOR:
            return assigned_teams_creator()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_CREATOR_PARENT_TICKET:
            return assigned_teams_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNED_TEAMS_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS:
            return assignees_assigned_teams()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT:
            return assignees_assigned_teams_account()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT:
            return assignees_assigned_teams_account_contact()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR:
            return assignees_assigned_teams_account_contact_creator()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET:
            return assignees_assigned_teams_account_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET:
            return assignees_assigned_teams_account_contact_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CREATOR:
            return assignees_assigned_teams_account_creator()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET:
            return assignees_assigned_teams_account_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_CONTACT_CREATOR:
            return assignees_assigned_teams_contact_creator()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET:
            return assignees_assigned_teams_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET:
            return assignees_assigned_teams_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_ASSIGNED_TEAMS_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS:
            return assignees_collections_assigned_teams()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT:
            return assignees_collections_assigned_teams_account()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT:
            return assignees_collections_assigned_teams_account_contact()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR:
            return assignees_collections_assigned_teams_account_contact_creator()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR:
            return assignees_collections_assigned_teams_account_creator()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET:
            return assignees_collections_assigned_teams_account_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET:
            return assignees_collections_assigned_teams_account_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT:
            return assignees_collections_assigned_teams_contact()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR:
            return assignees_collections_assigned_teams_contact_creator()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET:
            return assignees_collections_assigned_teams_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET:
            return assignees_collections_assigned_teams_contact_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CREATOR:
            return assignees_collections_assigned_teams_creator()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET:
            return assignees_collections_assigned_teams_creator_parent_ticket()
        if self is TicketsListRequestExpand.ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS:
            return attachments_assigned_teams()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT:
            return attachments_assigned_teams_account()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CONTACT:
            return attachments_assigned_teams_account_contact()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR:
            return attachments_assigned_teams_account_contact_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET:
            return attachments_assigned_teams_account_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET:
            return attachments_assigned_teams_account_contact_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CREATOR:
            return attachments_assigned_teams_account_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_CONTACT:
            return attachments_assigned_teams_contact()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_CONTACT_CREATOR:
            return attachments_assigned_teams_contact_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET:
            return attachments_assigned_teams_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET:
            return attachments_assigned_teams_contact_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_CREATOR:
            return attachments_assigned_teams_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT:
            return attachments_assignees_assigned_teams_account_contact()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR:
            return attachments_assignees_assigned_teams_account_contact_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET:
            return attachments_assignees_assigned_teams_account_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET:
            return attachments_assignees_assigned_teams_account_contact_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CREATOR:
            return attachments_assignees_assigned_teams_account_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET:
            return attachments_assignees_assigned_teams_account_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_CONTACT_CREATOR:
            return attachments_assignees_assigned_teams_contact_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET:
            return attachments_assignees_assigned_teams_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET:
            return attachments_assignees_assigned_teams_contact_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_CREATOR:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS:
            return attachments_assignees_collections_assigned_teams()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT:
            return attachments_assignees_collections_assigned_teams_account()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT:
        ...
        if (
            self
            is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET
        ):
            return attachments_assignees_collections_assigned_teams_account_contact_creator_parent_ticket()
        if (
            self
            is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET
        ):
            return attachments_assignees_collections_assigned_teams_account_contact_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR:
            return attachments_assignees_collections_assigned_teams_account_creator()
        if (
            self
            is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET
        ):
            return attachments_assignees_collections_assigned_teams_account_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET:
            return attachments_assignees_collections_assigned_teams_account_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT:
            return attachments_assignees_collections_assigned_teams_contact()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR:
            return attachments_assignees_collections_assigned_teams_contact_creator()
        if (
            self
            is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET
        ):
            return attachments_assignees_collections_assigned_teams_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET:
            return attachments_assignees_collections_assigned_teams_contact_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CREATOR:
            return attachments_assignees_collections_assigned_teams_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET:
            return attachments_assignees_collections_assigned_teams_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS:
        ...
        if (
            self
            is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET
        ):
            return attachments_collections_assigned_teams_account_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET:
            return attachments_collections_assigned_teams_account_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CONTACT:
        ...
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET:
            return attachments_collections_assigned_teams_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET:
            return attachments_collections_assigned_teams_contact_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CREATOR:
            return attachments_collections_assigned_teams_creator()
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET:
            return attachments_collections_assigned_teams_creator_parent_ticket()
        if self is TicketsListRequestExpand.ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS:
            return collections_assigned_teams()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT:
            return collections_assigned_teams_account()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT:
            return collections_assigned_teams_account_contact()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR:
            return collections_assigned_teams_account_contact_creator()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET:
            return collections_assigned_teams_account_contact_creator_parent_ticket()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET:
            return collections_assigned_teams_account_contact_parent_ticket()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR:
            return collections_assigned_teams_account_creator()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET:
            return collections_assigned_teams_account_creator_parent_ticket()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET:
            return collections_assigned_teams_account_parent_ticket()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_CONTACT:
            return collections_assigned_teams_contact()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR:
            return collections_assigned_teams_contact_creator()
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET:
        ...
        if self is TicketsListRequestExpand.COLLECTIONS_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET:
