...
class Comments(SyncAPIResource):
    ...
    def create(
        self,
        *,
        model: comment_create_params.Model,
        ...
        return self._post(
            ...
            body=maybe_transform({"model": model}, comment_create_params.CommentCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=CommentResponse,
        )
...
class AsyncComments(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Comment, AsyncPage[Comment]]:
        """
        Returns a list of `Comment` objects.
