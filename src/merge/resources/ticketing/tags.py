...
from ...types.ticketing import tag_list_params, tag_retrieve_params
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"include_remote_data": include_remote_data}, tag_retrieve_params.TagRetrieveParams
                ),
            ),
            cast_to=shared.Tag,
        )
...
class AsyncTags(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[shared.Tag, AsyncPage[shared.Tag]]:
        """
        Returns a list of `Tag` objects.
