...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CategoryEnum": ".types",
    "ChatSyncSelection": ".types",
    "ChatSyncSelectionType": ".types",
    "ChatSyncSelectionTypeEnum": ".types",
    "CommonModelScopeApi": ".types",
    "CommonModelScopesBodyRequest": ".types",
    "CompletedAccountInitialScreenEnum": ".types",
    "Conversation": ".types",
    "ConversationFieldMappings": ".types",
    "ConversationMembersItem": ".types",
    "ConversationType": ".types",
    "ConversationsMembersListRequestExpandItem": ".resources",
    ...
    "PaginatedChatSyncSelectionList": ".types",
