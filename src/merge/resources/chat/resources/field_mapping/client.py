...
class AsyncFieldMappingClient:
    ...
    async def field_mappings_retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.chat.field_mapping.field_mappings_retrieve(
                exclude_remote_field_metadata=True,
            )
    ...
    async def field_mappings_destroy(
        ...
        async def main() -> None:
            await client.chat.field_mapping.field_mappings_destroy(
                field_mapping_id="field_mapping_id",
            )
    ...
    async def remote_fields_retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.chat.field_mapping.remote_fields_retrieve(
                common_models="common_models",
                include_example_values="include_example_values",
            )
    ...
    async def target_fields_retrieve(
        ...
        async def main() -> None:
            await client.chat.field_mapping.target_fields_retrieve()
