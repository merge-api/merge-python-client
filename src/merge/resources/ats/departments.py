...
from ...types.ats import Department, department_list_params, department_retrieve_params
from ...pagination import SyncPage, AsyncPage
from ..._base_client import AsyncPaginator, make_request_options

__all__ = ["Departments", "AsyncDepartments"]


class Departments(SyncAPIResource):
    def retrieve(
        self,
        id: str,
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"include_remote_data": include_remote_data}, department_retrieve_params.DepartmentRetrieveParams
                ),
            ),
            cast_to=Department,
        )
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    department_list_params.DepartmentListParams,
                ),
            ),
            model=Department,
        )
...
class AsyncDepartments(AsyncAPIResource):
    async def retrieve(
        self,
        id: str,
        *,
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Department, AsyncPage[Department]]:
        """
        Returns a list of `Department` objects.
