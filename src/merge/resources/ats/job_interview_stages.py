...
from ...types.ats import (
    JobInterviewStage,
    job_interview_stage_list_params,
    job_interview_stage_retrieve_params,
)
from ...pagination import SyncPage, AsyncPage
from ..._base_client import AsyncPaginator, make_request_options

__all__ = ["JobInterviewStages", "AsyncJobInterviewStages"]


class JobInterviewStages(SyncAPIResource):
    def retrieve(
        self,
        id: str,
        *,
        expand: List[Literal["job"]] | NotGiven = NOT_GIVEN,
        ...
        """
        return self._get(
            f"/ats/v1/job-interview-stages/{id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    job_interview_stage_retrieve_params.JobInterviewStageRetrieveParams,
                ),
            ),
            cast_to=JobInterviewStage,
        )
    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          job_id: If provided, will only return interview stages for this job.
        ...
        return self._get_api_list(
            ...
            page=SyncPage[JobInterviewStage],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=maybe_transform(
                    ...
                    job_interview_stage_list_params.JobInterviewStageListParams,
                ),
            ),
...
class AsyncJobInterviewStages(AsyncAPIResource):
    async def retrieve(
        self,
        id: str,
        *,
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[JobInterviewStage, AsyncPage[JobInterviewStage]]:
        """
        Returns a list of `JobInterviewStage` objects.
        ...
        return self._get_api_list(
            "/ats/v1/job-interview-stages",
            page=AsyncPage[JobInterviewStage],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
