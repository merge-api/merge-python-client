...
from ...types.ats import user_list_params, user_retrieve_params
...
class Users(SyncAPIResource):
    def retrieve(
        ...
        *,
        ...
        remote_fields: Literal["access_role"] | NotGiven = NOT_GIVEN,
        show_enum_origins: Literal["access_role"] | NotGiven = NOT_GIVEN,
    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          email: If provided, will only return remote users with the given email address
        ...
        return self._get_api_list(
            "/ats/v1/users",
            page=SyncPage[shared.RemoteUser],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
...
class AsyncUsers(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[shared.RemoteUser, AsyncPage[shared.RemoteUser]]:
        """
        Returns a list of `RemoteUser` objects.
        ...
        return self._get_api_list(
            "/ats/v1/users",
            page=AsyncPage[shared.RemoteUser],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
