...
class ExternalTargetFieldApiResponse(UncheckedBaseModel):
    ...
    eeoc: typing_extensions.Annotated[
        typing.Optional[typing.List[ExternalTargetFieldApi]], FieldMetadata(alias="EEOC"), pydantic.Field(alias="EEOC")
    ] = None
    ...
    job: typing_extensions.Annotated[
        typing.Optional[typing.List[ExternalTargetFieldApi]], FieldMetadata(alias="Job"), pydantic.Field(alias="Job")
    ] = None
