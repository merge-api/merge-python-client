...
class Eeoc(UncheckedBaseModel):
    ...
    race: typing.Optional[RaceEnum] = pydantic.Field(default=None)
    """
    ...
    * `DECLINE_TO_SELF_IDENTIFY` - DECLINE_TO_SELF_IDENTIFY
    ...
    veteran_status: typing.Optional[VeteranStatusEnum] = pydantic.Field(default=None)
    """
    ...
    * `I_DONT_WISH_TO_ANSWER` - I_DONT_WISH_TO_ANSWER
    ...
    disability_status: typing.Optional[DisabilityStatusEnum] = pydantic.Field(default=None)
    """
