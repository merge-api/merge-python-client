...
class Job(UncheckedBaseModel):
    ...
    * `PROFILE` - PROFILE
    ...
    job_postings: typing.Optional[typing.List["JobJobPostingsItem"]] = pydantic.Field(default=None)
    """
...
update_forward_refs(Job, JobJobPostingsItem=JobJobPostingsItem, JobPosting=JobPosting, JobPostingJob=JobPostingJob)
