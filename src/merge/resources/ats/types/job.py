...
class Job(UncheckedBaseModel):
    ...
    * `PROFILE` - PROFILE
    ...
    job_postings: typing.Optional[typing.List[typing.Optional["JobJobPostingsItem"]]] = pydantic.Field(default=None)
    """
...
from .job_job_postings_item import JobJobPostingsItem  # noqa: E402, F401, I001

update_forward_refs(Job)
