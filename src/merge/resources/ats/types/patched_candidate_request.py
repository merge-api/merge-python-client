...
class PatchedCandidateRequest(UncheckedBaseModel):
    ...
    applications: typing.Optional[typing.List[PatchedCandidateRequestApplicationsItem]] = pydantic.Field(default=None)
    """
    Array of `Application` object IDs.
    """

    attachments: typing.Optional[typing.List[PatchedCandidateRequestAttachmentsItem]] = pydantic.Field(default=None)
    """
