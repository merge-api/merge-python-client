...
class AsyncScopesClient:
    ...
    async def default_scopes_retrieve(
        ...
        async def main() -> None:
            await client.knowledgebase.scopes.default_scopes_retrieve()
    ...
    async def linked_account_scopes_retrieve(
        ...
        async def main() -> None:
            await client.knowledgebase.scopes.linked_account_scopes_retrieve()
    ...
    async def linked_account_scopes_create(
        ...
        *,
        ...
        async def main() -> None:
            await client.knowledgebase.scopes.linked_account_scopes_create(
                common_models=[
                    IndividualCommonModelScopeDeserializerRequest(
                        model_name="Employee",
                        model_permissions={
