...
from ...types.paginated_knowledge_base_sync_selection_list import PaginatedKnowledgeBaseSyncSelectionList
...
class AsyncSelectiveSyncClient:
    ...
    async def conditions_list(
        ...
        async def main() -> None:
            await client.knowledgebase.selective_sync.conditions_list()
    ...
    async def selections_list(
        ...
        *,
        ...
        async def main() -> None:
            await client.knowledgebase.selective_sync.selections_list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
                page_size=1,
            )
