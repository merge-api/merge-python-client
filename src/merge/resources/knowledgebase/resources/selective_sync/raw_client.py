...
class RawSelectiveSyncClient:
    ...
    def conditions_list(
        ...
        _response = self._client_wrapper.httpx_client.request(
            "knowledgebase/v1/selective-sync/conditions",
            method="GET",
    ...
    def selections_list(
        ...
        *,
    ...
    ) -> HttpResponse[PaginatedKnowledgeBaseSyncSelectionList]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "knowledgebase/v1/selective-sync/selections",
            method="GET",
            params={
                "cursor": cursor,
                "page_size": page_size,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=PaginatedKnowledgeBaseSyncSelectionList,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawSelectiveSyncClient:
    ...
    async def selections_list(
        ...
        *,
        ...
        page_size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PaginatedKnowledgeBaseSyncSelectionList]:
        """
        Returns a list of `KnowledgeBaseSyncSelection` objects.
