...
from ....types.marketing import (
    ...
    campaign_retrieve_params,
    campaign_list_contacts_params,
)

if TYPE_CHECKING:
    from ...._client import Merge, AsyncMerge

__all__ = ["Campaigns", "AsyncCampaigns"]
...
class Campaigns(SyncAPIResource):
    ...
    def create(
        self,
        *,
        model: campaign_create_params.Model,
        ...
        return self._post(
            "/mktg/v1/campaigns",
            body=maybe_transform({"model": model}, campaign_create_params.CampaignCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=MktgCampaignResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"include_remote_data": include_remote_data}, campaign_retrieve_params.CampaignRetrieveParams
                ),
            ),
            cast_to=Campaign,
        )
    ...
    def list_contacts(
        ...
        *,
        ...
        """
        return self._get_api_list(
            f"/mktg/v1/campaigns/{parent_id}/contacts",
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    campaign_list_contacts_params.CampaignListContactsParams,
                ),
            ),
...
class AsyncCampaigns(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Campaign, AsyncPage[Campaign]]:
        """
        Returns a list of `Campaign` objects.
