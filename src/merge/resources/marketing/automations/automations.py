...
from ....types.marketing import (
    ...
    automation_list_recipients_params,
)
...
class Automations(SyncAPIResource):
    ...
    def create(
        self,
        *,
        model: automation_create_params.Model,
        ...
        return self._post(
            "/mktg/v1/automations",
            body=maybe_transform({"model": model}, automation_create_params.AutomationCreateParams),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"include_remote_data": include_remote_data}, automation_retrieve_params.AutomationRetrieveParams
                ),
            ),
            cast_to=Automation,
        )
    ...
    def list_recipients(
        ...
        *,
        ...
        """
        return self._get_api_list(
            f"/mktg/v1/automations/{parent_id}/recipients",
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    automation_list_recipients_params.AutomationListRecipientsParams,
                ),
            ),
...
class AsyncAutomations(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Automation, AsyncPage[Automation]]:
        """
        Returns a list of `Automation` objects.
