...
class Files(SyncAPIResource):
    ...
    def create(
        self,
        *,
        model: file_create_params.Model,
        ...
        return self._post(
            ...
            body=maybe_transform({"model": model}, file_create_params.FileCreateParams),
    ...
    def retrieve(
        ...
        id: str,
        *,
        expand: List[Literal["folder", "permissions"]] | NotGiven = NOT_GIVEN,
    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          folder_id: If provided, will only return files in this folder. If null, will return files
              in root directory.
          ...
          name: If provided, will only return files with this name. This performs an exact
              match.
