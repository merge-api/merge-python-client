...
class FileStorageClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        ...
        self._async_passthrough: typing.Optional[
            resources_file_storage_resources_async_passthrough_client_AsyncPassthroughClient
        ] = None
    ...
    def async_passthrough(self):
        if self._async_passthrough is None:
            from .resources.async_passthrough.client import (
                AsyncPassthroughClient as resources_file_storage_resources_async_passthrough_client_AsyncPassthroughClient,  # noqa: E402
            )

            self._async_passthrough = resources_file_storage_resources_async_passthrough_client_AsyncPassthroughClient(
...
class AsyncFileStorageClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        ...
        self._passthrough: typing.Optional[
            resources_file_storage_resources_passthrough_client_AsyncPassthroughClient
        ] = None
    ...
    def passthrough(self):
        if self._passthrough is None:
            from .resources.passthrough.client import (
                AsyncPassthroughClient as resources_file_storage_resources_passthrough_client_AsyncPassthroughClient,  # noqa: E402
            )

            self._passthrough = resources_file_storage_resources_passthrough_client_AsyncPassthroughClient(
                client_wrapper=self._client_wrapper
            )
        return self._passthrough
