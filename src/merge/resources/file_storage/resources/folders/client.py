...
class FoldersClient:
    ...
    ) -> SyncPager[Folder, PaginatedFolderList]:
        """
...
class AsyncFoldersClient:
    ...
    async def list(
        ...
        *,
        ...
        remote_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncPager[Folder, PaginatedFolderList]:
        """
        Returns a list of `Folder` objects.
        ...
        async def main() -> None:
            response = await client.file_storage.folders.list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            )
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.file_storage.folders.create(
                model=FolderRequest(),
            )
    ...
    async def retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.file_storage.folders.retrieve(
                id="id",
            )
