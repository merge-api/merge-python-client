...
class FilesClient:
    ...
    ) -> SyncPager[File, PaginatedFileList]:
        """
    ...
    def download_request_meta_list(
        ...
        *,
        ...
        page_size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> SyncPager[DownloadRequestMeta, PaginatedDownloadRequestMetaList]:
        """
...
class AsyncFilesClient:
    ...
    async def list(
        ...
        *,
        ...
        remote_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncPager[File, PaginatedFileList]:
        """
        Returns a list of `File` objects.
        ...
        async def main() -> None:
            response = await client.file_storage.files.list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            )
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.file_storage.files.create(
                model=FileRequest(),
            )
    ...
    async def download_request_meta_retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.file_storage.files.download_request_meta_retrieve(
                id="id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.download_request_meta_retrieve(
            id, mime_type=mime_type, request_options=request_options
        )
        return _response.data
    ...
    async def download_request_meta_list(
        ...
        *,
        ...
        page_size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncPager[DownloadRequestMeta, PaginatedDownloadRequestMetaList]:
        """
        Returns metadata to construct authenticated file download requests, allowing you to download files directly from the third-party.
        ...
        async def main() -> None:
            response = await client.file_storage.files.download_request_meta_list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            )
            async for item in response:
                yield item
    ...
    async def meta_post_retrieve(self, *, request_options: typing.Optional[RequestOptions] = None) -> MetaResponse:
        ...
        async def main() -> None:
            await client.file_storage.files.meta_post_retrieve()
