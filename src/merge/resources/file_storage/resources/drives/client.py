...
class DrivesClient:
    ...
    ) -> SyncPager[Drive, PaginatedDriveList]:
        """
...
class AsyncDrivesClient:
    ...
    async def list(
        ...
        *,
        ...
        remote_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncPager[Drive, PaginatedDriveList]:
        """
        Returns a list of `Drive` objects.
        ...
        async def main() -> None:
            response = await client.file_storage.drives.list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
            )
    ...
    async def retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.file_storage.drives.retrieve(
                id="id",
            )
