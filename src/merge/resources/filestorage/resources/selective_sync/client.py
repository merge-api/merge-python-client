...
class SelectiveSyncClient:
    ...
    def configurations_list(self) -> typing.List[LinkedAccountSelectiveSyncConfiguration]:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment.value}/", "api/filestorage/v1/selective-sync/configurations"),
    ...
    def meta_list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment.value}/", "api/filestorage/v1/selective-sync/meta"),
