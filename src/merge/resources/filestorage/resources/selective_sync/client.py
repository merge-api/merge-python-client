...
from ...types.paginated_file_storage_sync_selection_list import PaginatedFileStorageSyncSelectionList
...
class AsyncSelectiveSyncClient:
    ...
    async def conditions_list(
        ...
        async def main() -> None:
            await client.filestorage.selective_sync.conditions_list()
    ...
    async def labels_list(self, *, request_options: typing.Optional[RequestOptions] = None) -> LabelSelectionList:
        ...
        async def main() -> None:
            await client.filestorage.selective_sync.labels_list()
    ...
    async def selections_list(
        ...
        *,
        ...
        async def main() -> None:
            await client.filestorage.selective_sync.selections_list(
                cursor="cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw",
                page_size=1,
            )
