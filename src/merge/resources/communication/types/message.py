...
class Message(UncheckedBaseModel):
    ...
    # The Member Object
    ### Description
    The `Message` object is used to represent a message within the Communication account.
    ### Usage Example
    Fetch from the `GET /api/communication/v1/messages` endpoint and view their message.
    """
