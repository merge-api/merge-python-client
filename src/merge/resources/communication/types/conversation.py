...
class Conversation(UncheckedBaseModel):
    ...
    ### Description
    The `Conversation` object is used to represent a conversation within the Communication account.

    ### Usage Example
    Fetch from the `GET /api/communication/v1/conversations` endpoint and view their conversations.
    """
