...
class Member(UncheckedBaseModel):
    """
    # The Member Object
    ### Description
    The `Member` object is used to represent a member within the Communication account.

    ### Usage Example
    Fetch from the `GET /api/communication/v1/members` endpoint and view their members.
    """
