...
class User(UncheckedBaseModel):
    ...
    # The User Object
    ### Description
    The `User` object is used to represent a user within the Communication account.

    ### Usage Example
    Fetch from the `GET /api/communication/v1/users` endpoint and view their users.
    """
