...
class RawConversationsClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> HttpResponse[PaginatedConversationList]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            "communication/v1/conversations",
            method="GET",
            params={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=PaginatedConversationList,  # type: ignore
    ...
    def members_list(
        ...
        *,
        ...
        page_size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[PaginatedMemberList]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"communication/v1/conversations/{jsonable_encoder(conversation_id)}/members",
            method="GET",
            params={
                "cursor": cursor,
                "expand": expand,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    PaginatedMemberList,
                    construct_type(
                        type_=PaginatedMemberList,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def retrieve(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"communication/v1/conversations/{jsonable_encoder(id)}",
            method="GET",
            params={
                "expand": expand,
                "include_remote_data": include_remote_data,
...
class AsyncRawConversationsClient:
    ...
    async def list(
        ...
        *,
        ...
        remote_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PaginatedConversationList]:
        """
        Returns a list of `Conversation` objects.
    ...
    async def members_list(
        ...
        *,
        ...
        page_size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PaginatedMemberList]:
        """
        Returns a list of `Member` objects.
