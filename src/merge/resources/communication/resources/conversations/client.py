...
class ConversationsClient:
    ...
    def members_list(
        ...
        *,
        ...
        """
        _response = self._raw_client.members_list(
            conversation_id,
            cursor=cursor,
            expand=expand,
            include_deleted_data=include_deleted_data,
...
class AsyncConversationsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.communication.conversations.list()
    ...
    async def members_list(
        ...
        *,
        ...
        async def main() -> None:
            await client.communication.conversations.members_list(
                conversation_id="conversation_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.members_list(
            conversation_id,
            cursor=cursor,
            expand=expand,
            include_deleted_data=include_deleted_data,
    ...
    async def retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.communication.conversations.retrieve(
                id="id",
            )
