...
class RawFieldMappingClient:
    ...
    def field_mappings_retrieve(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "communication/v1/field-mappings",
            method="GET",
            params={
    ...
    def field_mappings_destroy(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"communication/v1/field-mappings/{jsonable_encoder(field_mapping_id)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
    ...
    def remote_fields_retrieve(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "communication/v1/remote-fields",
            method="GET",
            params={
    ...
    def target_fields_retrieve(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "communication/v1/target-fields",
            method="GET",
            request_options=request_options,
        )
        try:
