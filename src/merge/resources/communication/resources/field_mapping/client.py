...
class AsyncFieldMappingClient:
    ...
    async def field_mappings_retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.communication.field_mapping.field_mappings_retrieve()
    ...
    async def field_mappings_create(
        ...
        *,
        ...
        async def main() -> None:
            await client.communication.field_mapping.field_mappings_create(
                target_field_name="example_target_field_name",
                target_field_description="this is a example description of the target field",
                remote_field_traversal_path=["example_remote_field"],
                remote_method="GET",
    ...
    async def field_mappings_destroy(
        ...
        async def main() -> None:
            await client.communication.field_mapping.field_mappings_destroy(
                field_mapping_id="field_mapping_id",
            )
    ...
    async def field_mappings_partial_update(
        ...
        *,
        ...
        async def main() -> None:
            await client.communication.field_mapping.field_mappings_partial_update(
                field_mapping_id="field_mapping_id",
            )
    ...
    async def remote_fields_retrieve(
        ...
        *,
        ...
        async def main() -> None:
            await client.communication.field_mapping.remote_fields_retrieve()
    ...
    async def target_fields_retrieve(
        ...
        async def main() -> None:
            await client.communication.field_mapping.target_fields_retrieve()
