...
class TestProjects:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        project = client.ticketing.projects.retrieve(
    ...
    def test_method_list(self, client: Merge) -> None:
        project = client.ticketing.projects.list()
    ...
    def test_method_list_users(self, client: Merge) -> None:
        ...
        assert_matches_type(SyncPage[FileStorageUser], project, path=["response"])
...
class TestAsyncProjects:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        project = await client.ticketing.projects.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Project, project, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        project = await client.ticketing.projects.list()
    ...
    async def test_method_list_users(self, client: AsyncMerge) -> None:
        ...
        assert_matches_type(AsyncPage[FileStorageUser], project, path=["response"])
