...
class TestFiles:
    ...
    def test_method_list(self, client: Merge) -> None:
        file = client.file_storage.files.list()
    ...
    @parametrize
    def test_method_download(self, client: Merge) -> None:
        file = client.file_storage.files.download(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert file is None
...
class TestAsyncFiles:
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        file = await client.file_storage.files.list()
    ...
    @parametrize
    async def test_method_download(self, client: AsyncMerge) -> None:
        file = await client.file_storage.files.download(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert file is None
