...
class TestBenefits:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        ...
        assert_matches_type(Benefit, benefit, path=["response"])
    ...
    def test_method_list(self, client: Merge) -> None:
        ...
        assert_matches_type(SyncPage[Benefit], benefit, path=["response"])
...
class TestAsyncBenefits:
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        ...
        assert_matches_type(AsyncPage[Benefit], benefit, path=["response"])
