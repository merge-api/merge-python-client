...
class TestEmployments:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        ...
        assert_matches_type(Employment, employment, path=["response"])
    ...
    def test_method_list(self, client: Merge) -> None:
        employment = client.hris.employments.list()
        assert_matches_type(SyncPage[Employment], employment, path=["response"])
...
class TestAsyncEmployments:
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        employment = await client.hris.employments.list()
        assert_matches_type(AsyncPage[Employment], employment, path=["response"])
