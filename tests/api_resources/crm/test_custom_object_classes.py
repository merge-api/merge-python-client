...
class TestCustomObjectClasses:
    ...
    def test_method_list(self, client: Merge) -> None:
        custom_object_class = client.crm.custom_object_classes.list()
        assert_matches_type(SyncPage[CustomObjectClass], custom_object_class, path=["response"])
...
class TestAsyncCustomObjectClasses:
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        custom_object_class = await client.crm.custom_object_classes.list()
        assert_matches_type(AsyncPage[CustomObjectClass], custom_object_class, path=["response"])
