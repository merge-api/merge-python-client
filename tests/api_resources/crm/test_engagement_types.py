...
class TestEngagementTypes:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        engagement_type = client.crm.engagement_types.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(EngagementType, engagement_type, path=["response"])
    ...
    def test_method_list(self, client: Merge) -> None:
        engagement_type = client.crm.engagement_types.list()
        assert_matches_type(SyncPage[EngagementType], engagement_type, path=["response"])
    ...
    def test_method_list_remote_field_classes(self, client: Merge) -> None:
        engagement_type = client.crm.engagement_types.list_remote_field_classes()
        assert_matches_type(SyncPage[shared.RemoteFieldClass], engagement_type, path=["response"])
...
class TestAsyncEngagementTypes:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        engagement_type = await client.crm.engagement_types.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(EngagementType, engagement_type, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        engagement_type = await client.crm.engagement_types.list()
        assert_matches_type(AsyncPage[EngagementType], engagement_type, path=["response"])
    ...
    async def test_method_list_remote_field_classes(self, client: AsyncMerge) -> None:
        engagement_type = await client.crm.engagement_types.list_remote_field_classes()
        assert_matches_type(AsyncPage[shared.RemoteFieldClass], engagement_type, path=["response"])
