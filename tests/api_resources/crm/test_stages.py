...
class TestStages:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        stage = client.crm.stages.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Stage, stage, path=["response"])
    ...
    def test_method_list(self, client: Merge) -> None:
        stage = client.crm.stages.list()
        assert_matches_type(SyncPage[Stage], stage, path=["response"])
    ...
    def test_method_list_remote_field_classes(self, client: Merge) -> None:
        stage = client.crm.stages.list_remote_field_classes()
        assert_matches_type(SyncPage[shared.RemoteFieldClass], stage, path=["response"])
...
class TestAsyncStages:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        stage = await client.crm.stages.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Stage, stage, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        stage = await client.crm.stages.list()
        assert_matches_type(AsyncPage[Stage], stage, path=["response"])
    ...
    async def test_method_list_remote_field_classes(self, client: AsyncMerge) -> None:
        stage = await client.crm.stages.list_remote_field_classes()
        assert_matches_type(AsyncPage[shared.RemoteFieldClass], stage, path=["response"])
