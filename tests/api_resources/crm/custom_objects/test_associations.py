...
class TestAssociations:
    ...
    def test_method_update(self, client: Merge) -> None:
        association = client.crm.custom_objects.associations.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            source_class_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            source_object_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            target_class_id="string",
            target_object_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Association, association, path=["response"])

    @parametrize
    def test_method_list(self, client: Merge) -> None:
        association = client.crm.custom_objects.associations.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            custom_object_class_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(SyncPage[Association], association, path=["response"])
    ...
    def test_method_list_with_all_params(self, client: Merge) -> None:
        association = client.crm.custom_objects.associations.list(
            ...
            cursor="string",
            expand=["association_type", "association_type", "association_type"],
...
class TestAsyncAssociations:
    ...
    async def test_method_update(self, client: AsyncMerge) -> None:
        association = await client.crm.custom_objects.associations.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            source_class_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            source_object_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            target_class_id="string",
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        association = await client.crm.custom_objects.associations.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            custom_object_class_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(AsyncPage[Association], association, path=["response"])
