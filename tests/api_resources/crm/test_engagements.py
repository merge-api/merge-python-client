...
class TestEngagements:
    ...
    def test_method_create(self, client: Merge) -> None:
        engagement = client.crm.engagements.create(
            model={},
        )
        assert_matches_type(EngagementResponse, engagement, path=["response"])
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        ...
        assert_matches_type(Engagement, engagement, path=["response"])
    ...
    def test_method_update(self, client: Merge) -> None:
        engagement = client.crm.engagements.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            model={},
        )
        assert_matches_type(EngagementResponse, engagement, path=["response"])
    ...
    def test_method_list(self, client: Merge) -> None:
        engagement = client.crm.engagements.list()
        assert_matches_type(SyncPage[Engagement], engagement, path=["response"])
    ...
    def test_method_list_remote_field_classes(self, client: Merge) -> None:
        engagement = client.crm.engagements.list_remote_field_classes()
        assert_matches_type(SyncPage[shared.RemoteFieldClass], engagement, path=["response"])
...
class TestAsyncEngagements:
    ...
    async def test_method_create(self, client: AsyncMerge) -> None:
        engagement = await client.crm.engagements.create(
            model={},
        )
        assert_matches_type(EngagementResponse, engagement, path=["response"])
    ...
    async def test_method_update(self, client: AsyncMerge) -> None:
        engagement = await client.crm.engagements.update(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            model={},
        )
        assert_matches_type(EngagementResponse, engagement, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        engagement = await client.crm.engagements.list()
        assert_matches_type(AsyncPage[Engagement], engagement, path=["response"])
    ...
    async def test_method_list_remote_field_classes(self, client: AsyncMerge) -> None:
        engagement = await client.crm.engagements.list_remote_field_classes()
        assert_matches_type(AsyncPage[shared.RemoteFieldClass], engagement, path=["response"])
