...
class TestTemplates:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        template = client.marketing.templates.retrieve(
    ...
    def test_method_list(self, client: Merge) -> None:
        template = client.marketing.templates.list()
        assert_matches_type(SyncPage[Template], template, path=["response"])
...
class TestAsyncTemplates:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        template = await client.marketing.templates.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Template, template, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        template = await client.marketing.templates.list()
        assert_matches_type(AsyncPage[Template], template, path=["response"])
