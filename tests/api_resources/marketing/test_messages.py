...
class TestMessages:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        message = client.marketing.messages.retrieve(
    ...
    def test_method_list(self, client: Merge) -> None:
        message = client.marketing.messages.list()
    ...
    def test_method_list_recipients(self, client: Merge) -> None:
        message = client.marketing.messages.list_recipients(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(SyncPage[shared.Contact], message, path=["response"])
...
class TestAsyncMessages:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        message = await client.marketing.messages.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Message, message, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        message = await client.marketing.messages.list()
    ...
    async def test_method_list_recipients(self, client: AsyncMerge) -> None:
        message = await client.marketing.messages.list_recipients(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(AsyncPage[shared.Contact], message, path=["response"])
