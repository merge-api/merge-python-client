...
class TestEvents:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        event = client.marketing.events.retrieve(
    ...
    def test_method_list_contacts(self, client: Merge) -> None:
        event = client.marketing.events.list_contacts(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(SyncPage[shared.Contact], event, path=["response"])
...
class TestAsyncEvents:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        event = await client.marketing.events.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Event, event, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        event = await client.marketing.events.list()
    ...
    async def test_method_list_contacts(self, client: AsyncMerge) -> None:
        event = await client.marketing.events.list_contacts(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(AsyncPage[shared.Contact], event, path=["response"])
