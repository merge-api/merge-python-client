...
class TestDepartments:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        department = client.ats.departments.retrieve(
    ...
    def test_method_list(self, client: Merge) -> None:
        department = client.ats.departments.list()
        assert_matches_type(SyncPage[Department], department, path=["response"])
...
class TestAsyncDepartments:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        department = await client.ats.departments.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Department, department, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        department = await client.ats.departments.list()
        assert_matches_type(AsyncPage[Department], department, path=["response"])
