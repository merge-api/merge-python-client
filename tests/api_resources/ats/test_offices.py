...
class TestOffices:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        office = client.ats.offices.retrieve(
    ...
    def test_method_list(self, client: Merge) -> None:
        office = client.ats.offices.list()
        assert_matches_type(SyncPage[Office], office, path=["response"])
...
class TestAsyncOffices:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        office = await client.ats.offices.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Office, office, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        office = await client.ats.offices.list()
        assert_matches_type(AsyncPage[Office], office, path=["response"])
