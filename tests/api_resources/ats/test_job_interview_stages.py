...
class TestJobInterviewStages:
    ...
    def test_method_list(self, client: Merge) -> None:
        job_interview_stage = client.ats.job_interview_stages.list()
        assert_matches_type(SyncPage[JobInterviewStage], job_interview_stage, path=["response"])
...
class TestAsyncJobInterviewStages:
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        job_interview_stage = await client.ats.job_interview_stages.list()
        assert_matches_type(AsyncPage[JobInterviewStage], job_interview_stage, path=["response"])
