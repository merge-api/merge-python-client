...
class TestPurchaseOrders:
    ...
    def test_method_create(self, client: Merge) -> None:
        purchase_order = client.accounting.purchase_orders.create(
            model={},
        )
        assert_matches_type(PurchaseOrderResponse, purchase_order, path=["response"])
    ...
    def test_method_list(self, client: Merge) -> None:
        purchase_order = client.accounting.purchase_orders.list()
        assert_matches_type(SyncPage[PurchaseOrder], purchase_order, path=["response"])
    ...
    def test_method_list_with_all_params(self, client: Merge) -> None:
        purchase_order = client.accounting.purchase_orders.list(
            ...
            issue_date_before=parse_datetime("2019-12-27T18:11:19.117Z"),
...
class TestAsyncPurchaseOrders:
    ...
    async def test_method_create(self, client: AsyncMerge) -> None:
        purchase_order = await client.accounting.purchase_orders.create(
            model={},
        )
        assert_matches_type(PurchaseOrderResponse, purchase_order, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        purchase_order = await client.accounting.purchase_orders.list()
        assert_matches_type(AsyncPage[PurchaseOrder], purchase_order, path=["response"])
