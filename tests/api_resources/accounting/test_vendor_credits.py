...
class TestVendorCredits:
    ...
    def test_method_list(self, client: Merge) -> None:
        vendor_credit = client.accounting.vendor_credits.list()
        assert_matches_type(SyncPage[VendorCredit], vendor_credit, path=["response"])
...
class TestAsyncVendorCredits:
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        vendor_credit = await client.accounting.vendor_credits.list()
        assert_matches_type(AsyncPage[VendorCredit], vendor_credit, path=["response"])
