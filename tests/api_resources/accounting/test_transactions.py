...
class TestTransactions:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        transaction = client.accounting.transactions.retrieve(
    ...
    def test_method_list(self, client: Merge) -> None:
        transaction = client.accounting.transactions.list()
...
class TestAsyncTransactions:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        transaction = await client.accounting.transactions.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Transaction, transaction, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        transaction = await client.accounting.transactions.list()
