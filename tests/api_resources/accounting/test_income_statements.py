...
class TestIncomeStatements:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        income_statement = client.accounting.income_statements.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(IncomeStatement, income_statement, path=["response"])
    ...
    def test_method_list(self, client: Merge) -> None:
        income_statement = client.accounting.income_statements.list()
        assert_matches_type(SyncPage[IncomeStatement], income_statement, path=["response"])
...
class TestAsyncIncomeStatements:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        income_statement = await client.accounting.income_statements.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(IncomeStatement, income_statement, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        income_statement = await client.accounting.income_statements.list()
        assert_matches_type(AsyncPage[IncomeStatement], income_statement, path=["response"])
