...
class TestCashFlowStatements:
    ...
    def test_method_list(self, client: Merge) -> None:
        cash_flow_statement = client.accounting.cash_flow_statements.list()
        assert_matches_type(SyncPage[CashFlowStatement], cash_flow_statement, path=["response"])
...
class TestAsyncCashFlowStatements:
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        cash_flow_statement = await client.accounting.cash_flow_statements.list()
        assert_matches_type(AsyncPage[CashFlowStatement], cash_flow_statement, path=["response"])
