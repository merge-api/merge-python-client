...
class TestAttachments:
    ...
    def test_method_create(self, client: Merge) -> None:
        attachment = client.accounting.attachments.create(
            model={},
        )
        assert_matches_type(AccountingAttachmentResponse, attachment, path=["response"])

    @parametrize
    def test_method_retrieve(self, client: Merge) -> None:
        attachment = client.accounting.attachments.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(AccountingAttachment, attachment, path=["response"])
    ...
    def test_method_list(self, client: Merge) -> None:
        attachment = client.accounting.attachments.list()
        assert_matches_type(SyncPage[AccountingAttachment], attachment, path=["response"])
...
class TestAsyncAttachments:
    ...
    async def test_method_create(self, client: AsyncMerge) -> None:
        attachment = await client.accounting.attachments.create(
            model={},
        )
        assert_matches_type(AccountingAttachmentResponse, attachment, path=["response"])
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        attachment = await client.accounting.attachments.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(AccountingAttachment, attachment, path=["response"])
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        attachment = await client.accounting.attachments.list()
        assert_matches_type(AsyncPage[AccountingAttachment], attachment, path=["response"])
