...
class TestTaxRates:
    ...
    def test_method_list(self, client: Merge) -> None:
        tax_rate = client.accounting.tax_rates.list()
        assert_matches_type(SyncPage[TaxRate], tax_rate, path=["response"])
...
class TestAsyncTaxRates:
    ...
    async def test_method_list(self, client: AsyncMerge) -> None:
        tax_rate = await client.accounting.tax_rates.list()
        assert_matches_type(AsyncPage[TaxRate], tax_rate, path=["response"])
