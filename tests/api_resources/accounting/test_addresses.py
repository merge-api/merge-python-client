...
class TestAddresses:
    ...
    def test_method_retrieve(self, client: Merge) -> None:
        address = client.accounting.addresses.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(shared.Address, address, path=["response"])
...
class TestAsyncAddresses:
    ...
    async def test_method_retrieve(self, client: AsyncMerge) -> None:
        address = await client.accounting.addresses.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(shared.Address, address, path=["response"])
